...
class BotFactoryDB:
    ...
    def _create_tables(self):
        ...
        # جدول المحظورين على مستوى النظام
        self.cursor.execute('''
